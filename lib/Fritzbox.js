...
var _TR064_DESC_URL = "/tr64desc.xml";
var _IGD_DESC_URL = "/igddesc.xml";
var _PMR_DESC_URL = "/pmr/PersonalMessageReceiver.xml";
...
function Fritzbox(options){
  ...
  this.TR064_DESC_URL = this.options.remote ? '/tr064' + _TR064_DESC_URL : _TR064_DESC_URL;
  this.IGD_DESC_URL = this.options.remote ? '/tr064' + _IGD_DESC_URL : _IGD_DESC_URL;
  // Dose not exist if you use remote
  this.PMR_DESC_URL = this.options.remote ? '/tr064' + _PMR_DESC_URL : _PMR_DESC_URL;
...
Fritzbox.prototype.initTR064Device = function(){
	return this._parseDesc(this.TR064_DESC_URL);
};
Fritzbox.prototype.initIGDDevice = function(){
	return this._parseDesc(this.IGD_DESC_URL);
};
Fritzbox.prototype.initPMRDevice = function(){
  return  this._parseDesc(this.PMR_DESC_URL);
};
